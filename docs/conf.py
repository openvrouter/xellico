...
htmlhelp_basename = 'DPDKperformanceoptimizationdoc'
...
man_pages = [
    (master_doc, 'dpdkperformanceoptimization', 'DPDK performance optimization Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DPDKperformanceoptimization', 'DPDK performance optimization Documentation',
     author, 'DPDKperformanceoptimization', 'One line description of project.',
     'Miscellaneous'),
]
